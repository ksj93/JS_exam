...
$(document).ready(function () {
  ...
  function score_indicate() {
    ...
    let $scroe_number = $('.container input').length
    let average = sum/$scroe_number
  ...
  function judgement() {
    ...
    let declaration_text = $('#declaration label').creatElement('p')
    declaration_text.textcontent = `あなたの成績は${achievement}です。${pass_or_failure}です。`
  };
